...
| `quality` | 可选 | eslint · @eslint/js · eslint-plugin-vue · typescript-eslint · prettier · globals | `eslint.config.js` · `.prettierrc.json`           | [ESLint](https://eslint.org) · [Prettier](https://prettier.io) · [typescript-eslint](https://typescript-eslint.io)                                                                                 |
| `build`   | 可选 | rollup-plugin-visualizer · vite-plugin-vue-devtools                              | `vite.config.ts`                                  | [visualizer](https://github.com/btd/rollup-plugin-visualizer) · [Vue DevTools](https://devtools.vuejs.org)                                                                                         |
